...
public partial class MovieStoreContext : MovieIdentityContext
{
...
//        => optionsBuilder.UseMySql("server=127.0.0.1;database=movieStore;user=root;password=root", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.4.0-mysql"));
